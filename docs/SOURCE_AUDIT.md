...
The selected `workspace/designs/ads-business-freedom-content-e2e-r1/BRIEF.md`
asks for an optional editable native
...
was treated as adoption authority. Its canonical `DESIGN.md` selected the optional
adapter, and its `REVIEW.md` records the supervised editable source,
