...
description: Turn a product or business brief into a focused DESIGN.md, inspectable browser preview, and portable handoff. Use when a landing page, application interface, workspace, dashboard, or report needs visual direction before Solution-template or PowerBI-template builds it.
---
...
2. Name the audience, current constraint, one primary action or decision, real
   content/data, required states, constraints, proof, and receiving owner.
...
`tailwind.theme.json`, and `HANDOFF.md`. The receiving repository becomes the
canonical owner; this repository remains a design workbench, not a dependency.
