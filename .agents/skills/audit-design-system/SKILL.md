...
description: Read-only ADS-local route for checking accumulated design System drift in an explicit scope.
---
...
OpenPencil is checked only when explicitly selected evidence exists; ordinary
HTML/tokens handoffs remain valid without it.
